...
const teamData = [
    ...
    },
    {
        ...
        content: `<p>Dr. Hanif Livani brings over 15 years of combined academic and industry experience in power systems, with deep expertise in transmission operation and planning, generator and large load interconnection studies, grid modernization, and the deployment of grid enhancement technologies across North America, including NYISO, PJM, and MISO. He holds a PhD in Electrical Engineering from Virginia Tech. Besides his position at Qaudrante USA, he serves as a professor in the University of Nevada Reno and leads the power system research lab with access to one of the largest HIL facilities in the Western US. His academic work bridges theory and practice, supporting grid modernization initiatives, reliability and resilience assessments, and the integration of advanced energy technologies. Dr. Livani has published extensively in peer-reviewed journals and international conferences and has played a key role in translating research outcomes into practical tools and methodologies adopted by industry.</p>`
    },
    {
        ...
        content: `<p>Dr. Ali Mehrizi-Sani is a recognized leader in modern power systems, specializing in grid modernization, inverter-dominated systems, microgrids, and the secure integration of renewable energy at scale. His work focuses on solving high-impact challenges across grid stability, protection, HVDC systems and FACTS, and advanced power electronics in increasingly digital and automated networks. He brings deep, hands-on experience working with utilities, system operators, technology companies, and government laboratories to translate advanced research into practical, deployable solutions. In addition to his role at Right Analytics, Dr. Mehrizi-Sani is a Professor and Bradley Senior Fellow at Virginia Tech and Director of the Virginia Tech Power and Energy Center, where he leads strategic research and industry engagement shaping the future of electric power infrastructure. He has led or contributed to more than $78 million in funded R&D initiatives, including over $15 million as principal investigator or institutional awardee, with outcomes that have directly influenced utility planning, industry practices, and standards development. Dr. Mehrizi-Sani has authored over 210 peer-reviewed publications and serves as Senior Editor of IEEE Transactions on Energy Conversion. He holds a Ph.D. in Electrical Engineering from the University of Toronto and has held advisory and consulting roles with leading international energy organizations.</p>`
    },
    {
